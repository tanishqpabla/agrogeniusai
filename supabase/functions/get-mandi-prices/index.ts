...
function generateMockData(state: string, district: string, commodity: string, market: string) {
  ...
  const stateMarkets: Record<string, Record<string, string[]>> = {
    ...
    'Madhya Pradesh': {
      'Indore': ['Indore Mandi', 'Rajendra Nagar Mandi', 'Sanwer Mandi', 'Mhow Mandi', 'Depalpur Mandi'],
      'Dewas': ['Dewas Mandi', 'Sonkatch Mandi', 'Bagli Mandi'],
      'Ujjain': ['Ujjain Mandi', 'Nagda Mandi', 'Barnagar Mandi', 'Tarana Mandi'],
      'Dhar': ['Dhar Mandi', 'Manawar Mandi', 'Kukshi Mandi', 'Sardarpur Mandi'],
      'Ratlam': ['Ratlam Mandi', 'Jaora Mandi', 'Alot Mandi', 'Sailana Mandi'],
      'Khargone': ['Khargone Mandi', 'Barwani Mandi', 'Kasrawad Mandi'],
      'Khandwa': ['Khandwa Mandi', 'Burhanpur Mandi', 'Pandhana Mandi'],
      'Shajapur': ['Shajapur Mandi', 'Agar Malwa Mandi', 'Shujalpur Mandi'],
      'Mandsaur': ['Mandsaur Mandi', 'Neemuch Mandi', 'Garoth Mandi'],
      'Sehore': ['Sehore Mandi', 'Ashta Mandi', 'Ichhawar Mandi'],
      'Bhopal': ['Bhopal Mandi', 'Vidisha Mandi', 'Berasia Mandi'],
      'Jabalpur': ['Jabalpur Mandi', 'Katni Mandi', 'Sihora Mandi'],
      'Gwalior': ['Gwalior Mandi', 'Morena Mandi', 'Dabra Mandi'],
    },
    'Rajasthan': {
